...
import ContainerMapStation from "../../components/graphs/ContainerMapStation"
import CreateForm from "app/users/components/CreateForm";
import QueryForm from "app/users/components/QueryForm";

const userSelector = state => state.geolocations
...
export default connect(userRecordSelector, bindActions)(ContainerMapStation);
